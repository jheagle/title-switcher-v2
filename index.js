...
/*********************************************
 ...
 argument to TitleSwitcher.
 **********************************************/
const TitleSwitcher = function (titlesContainer, switchStyle = 'typingEffect') {
  const _self = this
  ...
  this.startTitles = function (settings = {}) {
    ...
    if (currentTitle.classList) {
      currentTitle.classList.add(_self.currentClass)
    } else {
      currentTitle.className += ' ' + _self.currentClass
    }
    const self = this
    ...
    if (typeElement.classList) {
      typeElement.classList.remove(_self.currentClass)
    } else {
  ...
  this.switchTitle = function (currentTitle, callBackFunction, self) {
    ...
    if (currentTitle.classList) {
      currentTitle.classList.remove(_self.currentClass)
    } else {
    ...
    if (nextTitle.classList) {
      nextTitle.classList.add(_self.currentClass)
    } else {
      nextTitle.className += ' ' + _self.currentClass
    }
